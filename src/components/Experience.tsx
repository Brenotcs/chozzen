...
export function Experience() {
  return (
    <>
      ...
      <section id="experience" className="py-30 md:py-20 bg-gradient-to-b from-black-abyss to-purple-deep/10">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {CARDS.map((card, i) => (
              <div
                key={i}
                className="p-8 border border-violet/15 bg-purple-deep/6 relative transition-all duration-300 overflow-hidden group hover:border-violet/40 hover:bg-purple-deep/18 hover:-translate-y-1"
              >
