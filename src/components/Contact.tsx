...
export function Contact() {
  ...
  return (
    <>
      ...
      <section ref={sectionRef} id="contact" className="py-16 sm:py-20 md:py-24 lg:py-30 relative text-center bg-gradient-to-b from-black-abyss to-purple-deep/20 scroll-reveal">
        <div className="container relative z-10">
          <span className="section-label animate-fade-in-up animate-delay-100" data-animate-on-reveal>◈ 005 — Bookings</span>
          <h2 className="section-title animate-fade-in-up animate-delay-200" data-animate-on-reveal>Contact</h2>
          <p className="text-xs sm:text-sm md:text-sm text-silver/45 font-light tracking-widest mb-8 sm:mb-10 md:mb-14 max-w-md mx-auto leading-relaxed animate-fade-in-up animate-delay-300" data-animate-on-reveal>
