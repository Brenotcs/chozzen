...
export function Contact() {
  return (
    <>
      ...
      <section id="contact" className="py-16 sm:py-20 md:py-24 lg:py-30 relative text-center bg-gradient-to-b from-black-abyss to-purple-deep/20">
        {/* Glow effect */}
        <div className="absolute w-[min(700px,120vw)] h-[min(700px,120vw)] rounded-full bg-gradient-radial from-purple-deep/50 to-transparent top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />

        <div className="container relative z-10">
          <span className="section-label">◈ 005 — Bookings</span>
          <h2 className="section-title">Contact</h2>
          <p className="text-xs sm:text-sm md:text-sm text-silver/45 font-light tracking-widest mb-8 sm:mb-10 md:mb-14 max-w-md mx-auto leading-relaxed">
            Transforme seu evento em uma experiência de frequência. Entre em contato para bookings e parcerias.
          </p>

          {/* Contact Links */}
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-8 sm:mb-10 md:mb-14">
            <a
              href="mailto:booking@chozzen.com"
              className="flex items-center gap-2 px-3 sm:px-4 md:px-7 py-2 sm:py-2.5 md:py-3.5 border border-violet/25 text-silver/65 text-xs tracking-widest uppercase transition-all duration-300 hover:border-blue-freq hover:text-white hover:shadow-[0_0_20px_rgba(61,107,240,0.2)] hover:-translate-y-0.5 min-h-[40px] md:min-h-auto"
            >
