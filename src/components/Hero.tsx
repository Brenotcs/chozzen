...
export function Hero() {
  ...
  return (
    <section id="hero" className="h-screen relative flex items-center justify-center overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-purple-deep/80 via-blue-freq/15 to-black-abyss" />
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <div className="mt-12 opacity-0 animate-[fadeUp_1s_ease_forwards_1.1s]">
          <a
            ...
            className="btn-primary relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-violet before:to-blue-freq before:scale-x-0 before:origin-left before:transition-transform before:duration-500 before:-z-10 hover:before:scale-x-100"
          >
            Book Now
          </a>
        </div>
