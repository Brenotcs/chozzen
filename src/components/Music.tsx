    ...
    <>
      ...
      <section id="music" className="py-30 md:py-20 bg-black-abyss">
        <div className="container">
          ...
          <div className="relative border border-violet/20 p-8 md:p-10 lg:p-15 bg-purple-deep/8 overflow-hidden">
            {/* Top border gradient */}
            ...
            {/* Waveform */}
            <div className="flex items-center justify-center gap-1 mb-6 md:mb-8 h-16 md:h-20">
              {WAVE_BARS.map((b) => (
                <div
                  key={b.id}
                  className="w-0.5 md:w-1 bg-gradient-to-t from-blue-freq to-violet rounded animate-wave"
            ...
            {/* Quote */}
            <p className="font-zen text-base md:text-lg text-silver/50 tracking-widest text-center mb-2 md:mb-3">
