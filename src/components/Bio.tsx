      ...
      >
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-6 sm:gap-8 md:gap-16 lg:gap-20 xl:gap-32 items-center">
            {/* Image */}
            <div
              className="relative animate-fade-in-left animate-delay-200"
            ...
            {/* Text */}
            <div
              className="animate-fade-in-right animate-delay-300"
              data-animate-on-reveal
            >
              <span className="section-label animate-fade-in-up animate-delay-300">
                ◈ 001 — Identidade
              </span>
              <h2 className="section-title animate-fade-in-up animate-delay-400">
                Bio
              </h2>
